...
class CachePeer( BranchPeer ):
    ...
    def __fileget_handler(self, peerconn, data):
        ...
        if hashcode not in self.cachefile:
            ...
            return
        try:
            pathfilename = os.getcwd()+CACHE_FILE_DIRS+hashcode
    ...
    def addfile( self, logfile ):
        ...
        for i in xrange(len(lines)):
            ...
            hashcode = fileinfo[0].rstrip().lstrip()
            #filename = fileinfo[1]
            filesize = fileinfo[1].rstrip().lstrip()
    ...
    def __filechunkget_handler(self, peerconn, data):
        ...
        # print '1'
        tmppath= os.getcwd() + CACHE_FILE_DIRS +'tmp'
